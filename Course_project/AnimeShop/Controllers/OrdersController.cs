...
namespace AnimeShop.Controllers
{
    ...
    public class OrdersController : Controller
    {
        ...
        public async Task<IActionResult> Checkout(Order order)
        {
            ...
            {
                ModelState.AddModelError("", "Ваша корзина пуста, добавьте сначала товары");
            }
        ...
        {
            ViewBag.CheckoutCompleteMessage = $"Спасибо за ваш заказ, мы доставим ваш заказ в ближайшее время!";
            return View();
        }
        ...
        public async Task<IActionResult> Details(int id)
        {
            ...
            if (isAdmin == false)
            {
                ...
                {
                    return BadRequest("У вас нет прав для просмотра этого заказа.");
                }
            }

            var orderDetailsList = _context.OrderDetails.Include(o => o.Anime).Include(o => o.Order)
